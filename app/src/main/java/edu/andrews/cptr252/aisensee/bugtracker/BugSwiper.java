 ...
 */
public class BugSwiper extends ItemTouchHelper.SimpleCallback{
    ...
    public BugSwiper(BugAdapter adapter) {
     ...
     * Our app does not support moving bugs, so the function just returns false.
    ...
    public boolean onMove(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder target) {
        return false;   // bug cannot be moved, only swiped left or right.
    }
    ...
    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
        ...
        mAdapter.deleteBug(deletedPosition);
    }
